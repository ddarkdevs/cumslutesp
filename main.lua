...
local UILibrary = loadstring(game:HttpGet("https://raw.githubusercontent.com/ddarkdevs/cumslutesp/main/ui.lua"))();
...
local GetConfig = function()
	local Good, Config = pcall(readfile, "cumslut-esp-v1.json");
	if (Good) then
		...
		if (Decoded.Version ~= 1.1) then
			...
			writefile("cumslut-esp-v1.json", Encoded);
		end
...
local MainUI = UILibrary.new(Color3.fromRGB(228, 17, 255));
local Window = MainUI:LoadWindow('<font color="#f89cd8">cumslut</font> esp', UDim2.fromOffset(400, 279));
